                    ...
                    <div className="row d-flex justify-content-center align-items-center">
                        ...
                        <div className="col-lg-5 col-md-6 col-sm-12">
                            <div className="mb-3">
                                ...
                                <select className="form-select" aria-label="Default select example" name='vendorName'>
                        ...
                        <div className="col-lg-5 col-md-6 col-sm-12">
                            <div className="mb-3">
                                <label for="exampleInputEmail1" className="form-label">Select Vendor Type</label>
                                <select className="form-select" aria-label="Default select example">
